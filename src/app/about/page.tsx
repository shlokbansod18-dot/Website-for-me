    ...
    <>
      <section className="on-ivory py-20 lg:py-32">
        <div className="shell">
          ...
          <h1 className="display mt-7 max-w-[14ch]" data-enter="drift">
      ...
      <section className="on-stone alive py-20 lg:py-28">
        <div className="shell">
          <h2 className="display-2 max-w-[16ch]" data-enter="snap">
            What you get, every time
          </h2>
          <dl className="enter mt-14 grid gap-px overflow-hidden border border-line bg-line sm:grid-cols-2">
      ...
      <section className="on-ink py-20 lg:py-28">
        <div className="shell grid gap-12 lg:grid-cols-[1fr_1fr] lg:gap-20">
          <div>
            <h2 className="display-2 max-w-[13ch]" data-enter="part">
