    ...
    <div className="shell py-12 lg:py-16">
      <header className="mb-10 flex flex-wrap items-end justify-between gap-6">
        <div className="flex items-center gap-4">
          <span className="grid size-14 shrink-0 place-items-center rounded-full bg-acid font-display text-xl font-bold text-acid-ink">
        ...
        <form action={signOutAction}>
          <button
            type="submit"
            className="rounded-full border border-line px-4 py-2 text-[0.8125rem] text-dim transition-colors hover:border-flare hover:text-flare"
          >
            Sign out
          </button>
        </form>
